...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.hcl.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.113:8181/SOAPWebServiceDemo/services/Calculator";
    ...
    public com.hcl.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.hcl.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.CalculatorSoapBindingStub _stub = new com.hcl.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.CalculatorSoapBindingStub _stub = new com.hcl.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://hcl.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://hcl.com", "Calculator"));
        }
